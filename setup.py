...
plugin_identifier = "jogwheel"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_jogwheel"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "Jog Wheel Control"
...
# module
plugin_description = """Replaces the control tab axis buttons with a jog wheel interface."""
...
plugin_url = "https://github.com/jneilliii/OctoPrint-JogWheelControl"
